...
class ChatFragment : Fragment(), ContactClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this,ChatViewModelFactory(requireActivity().application)).get(ChatViewModel::class.java)
    ...
    override fun OndpClick(position: Int) {
        DpDialogFragment.newInstance(cl[position].pplink).show(requireActivity().supportFragmentManager,"")
    }
